...
import t1 from "./Vasu Arora.jpeg";
      ...
      <section className="share section bd-container" id="learn_more">
        <div className="share__container bd-grid">
          ...
          <div className="share__data"
            ...
            <p className="share__description"> With TechInnovate, you can seamlessly connect with like-minded individuals, build diverse teams, and amplify your impact in hackathons.</p>
          </div>
        </div>
      </section>
      ...
      <section className="decoration section bd-container" id="features">
        ...
        <div className="decoration__container bd-grid">
          ...
          <div className="decoration__data">
            ...
            <div className="button"><Link to="/portfolio-gen-frontend" className="button-link" style={{ color: 'white' }}>Explore</Link>
            </div>
          </div>
          <div className="decoration__data">
      ...
      <section className="decoration section bd-contain" id="team">
        ...
        <div className="decoration__container bd-grid">
          <div className="decoration__data">
            ...
            <h3 className="decoration__title">Vasu Arora</h3>
